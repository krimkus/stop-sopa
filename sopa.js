...
#text-shadow-box #tsb-link a { \
 ...
 \
#text-shadow-box #tsb-opaque-box,\
...
<div id='text-shadow-box'> \
    ...
    <div id='tsb-wall'> \
        <div id='tsb-ie'></div> \
         \
        <p>This site has gone dark today in protest of the U.S. Stop Online Piracy Act (SOPA) and PROTECT-IP Act (PIPA). The U.S. Congress is about to censor the Internet, even though the vast majority of Americans are opposed. We need to kill these bills to protect our rights to free speech, privacy, and prosperity. <a href='http://www.congressmerge.com/onlinedb/'>Call, fax</a> and <a href='https://wfc2.wiredforchange.com/o/9042/p/dia/action/public/?action_KEY=8173'>email</a> your Senator and Representative today. Learn more at <a href='http://americancensorship.org/'>AmericanCensorship.org</a> and <a href='http://sopablackout.org/learnmore'>SOPABlackout.org</a></p> \
    </div> \
    <div id='tsb-spot'></div> \
</div> \
 \
